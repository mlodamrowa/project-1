...
<div class="col-12 text-center text float-left">
    ...
    echo "<div class='col-12 text-center list float-left'>";
        $i = $page - 1;
        if($page > 1 ) echo '<a href="./spis_tresci.php?page='.$i.'">'.'<< '.'</a>';
        if($page > 1 ) echo '<a href="./spis_tresci.php?page=1">1</a> ...';
        if($page > 1 ) echo '<a href="./spis_tresci.php?page='.$i.'"> '.$i.'</a>';
        echo '<a class="listCheck" href="./spis_tresci.php?page='.$page.'"> '.$page.'</a>';
        $i = $page + 1;
        if($page != $page_count) echo '<a href="./spis_tresci.php?page='.$i.'"> '.$i.'</a>';
        echo ' ... <a href="./spis_tresci.php?page='.$page_count.'"> '.$page_count.'</a>';
        if($page_count > 1 && $page != $page_count ) echo '<a href="./spis_tresci.php?page='.$i.'">'.' >>'.'</a>';
